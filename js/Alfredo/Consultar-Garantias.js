$(function(){
	...
	$.ajax({
		url: "https://notas-taller.000webhostapp.com/php/Alfredo/ObtenerGarantias.php",
		dataType: "json",
		type: "GET",
	...
	$('#principal tbody').on( 'click', 'tr', function() {
		$.ajax({
			url: "https://notas-taller.000webhostapp.com/php/Alfredo/DescargarGarantia.php",
			datatype: "json",
			data: {
				IDGarantia:tabla.row(this).data()[0],
